...
-- o_d10a için veritabanı yapısı dökülüyor
CREATE DATABASE IF NOT EXISTS `o_d10a` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `o_d10a`;

-- tablo yapısı dökülüyor o_d10a.oyun
...
-- o_d10a.oyun: ~0 rows (yaklaşık) tablosu için veriler indiriliyor
